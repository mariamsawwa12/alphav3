...
class _AdviceScreenState extends State<AdviceScreen> {
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _SectionTitle(
                    title: 'What are you planning to buy?',
                    isDark: isDark,
                    screenW: screenW,
                  ),
                  SizedBox(
                  ...
                  CustomTextfield(
                    ...
                    hint: 'Example: Laptop, phone or trip',
                  ...
                  _SectionTitle(
                    title: 'Is this expense planned or urgent?',
                    isDark: isDark,
                    screenW: screenW,
                  ),
                  SizedBox(
                  ...
                  _SectionTitle(
                    title: 'Can the purchase wait for a few days?',
                    isDark: isDark,
                    screenW: screenW,
                  ),
                  SizedBox(
                  ...
                  _SectionTitle(
                    title: 'Did you check a cheaper alternative?',
                    isDark: isDark,
                    screenW: screenW,
                  ),
                  SizedBox(
  ...
  void _createAdviceResult() {
    ...
    if (_fundingSource == 'Emergency Fund') {
      if (_planningType == 'Urgent' && _expenseType == 'Need') {
        riskScore -= 1;
      } else {
        riskScore += 4;
      }
    ...
    if (riskScore >= 8) {
      _adviceLevel = AdviceLevel.highRisk;
      _resultTitle = 'Alpha recommends waiting';
    ...
    if (riskScore >= 4) {
      ...
      _resultTitle = 'Review before purchasing';
  ...
  void _clearResult() {
    if (_showResult || _errorMessage != null) {
      setState(() {
        _showResult = false;
        _errorMessage = null;
      });
...
class _AdviceResultCard extends StatelessWidget {
  final String title;
  final String message;
